...
public class ConsumeApi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        data.put("idClient", Configuration.getInstance().getIdClient());
        data.put("passKey", Configuration.getInstance().getPassKey());
        ...
        url.set("idClient", Configuration.getInstance().getIdClient());
        url.set("passKey", Configuration.getInstance().getPassKey());
        url.set("idStop", "3727");
