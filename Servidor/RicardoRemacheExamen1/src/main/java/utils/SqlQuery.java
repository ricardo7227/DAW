...
public class SqlQuery {
    ...
    public static String SELECT_NOMBRE = "SELECT *  FROM LOGIN_PHP WHERE NOMBRE = ? AND PASSWORD = ?";
    public static String SELECT_USER = "SELECT *  FROM USERS WHERE NOMBRE = ?";
    
    public static String INSERT_USERS = "INSERT INTO `USERS` ( `NOMBRE`, `PASSWORD`, `ACTIVO`) VALUES "
            + "( ?, ?, '1')";
    public static String UPDATE_ACTIVO_USER = "UPDATE USERS SET ACTIVO = ? WHERE NOMBRE = ?";
    //
    ...
    public static String SELECT_ALL_COCHES = "SELECT * FROM EXAMEN,EXAMEN1 WHERE EXAMEN.ID = EXAMEN1.ID_EXAMEN";
