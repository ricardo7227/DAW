 ...
 * @author daw
 */
@WebServlet(name = "ValidateOauth", urlPatterns = {"/validateOauth"})
public class ValidateOauth extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String clientSecret = "C7qekYMZlU8OpUYoyRKIFxVk";
        ...
        String body = post("https://accounts.google.com/o/oauth2/token", ImmutableMap.<String, String>builder()
                ...
                .put("redirect_uri", "http://localhost:8080/GoogleOAUTH/validateOauth")
