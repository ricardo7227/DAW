...
<li id="foli0" class="     ">
<a href='altaalumnos.php'>alta alumno</a><br/><br/>
...
<select id="Field25" name="idsancion" tabindex="7" > 
        <?
            $mMysqli = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE);
            $query="select idsancion,descripcion from sanciones order by 2 desc";
            $stmt= $mMysqli->prepare($query);
...
<div>
<input type="text" id="profesor" name="profesor" class="field textarea medium" tabindex="9"/>
</div>
</li> 
