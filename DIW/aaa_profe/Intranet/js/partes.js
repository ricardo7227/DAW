...
function updateAlumno(){    
    self.location='Jefatura/Partes/partes/updatealumno.php?idalumno=' + document.getElementById("Field35").value;
}
function altaalumno(){
...
function checkleves() {
    ...
    if ( tipoFalta == "L") {
        if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0){
            ...
            xmlHttp.open("GET", "Jefatura/Partes/partes/checkleves.php?idalumno=" + idalumno, true);
...
function alumnos(curso){
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == 0){
        ...
        // execute the quickstart.php page from the server      
        xmlHttp.open("GET", "Jefatura/Partes/partes/alumnos.php?curso="+curso, true);
        // define the method to handle server responses
...
function verParteAlumno(){
    self.location="Jefatura/Partes/partes/partesalumno.php?idalumno=" + encodeURIComponent(document.getElementById("Field35").value);
}
