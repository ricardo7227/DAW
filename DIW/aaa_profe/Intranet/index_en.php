...
/*
    elseif ($_SERVER['QUERY_STRING'] == 'tictab')
    {
	    echo '<!DOCTYPE html>
                  <html>
                     <head>
                        <meta http-equiv="refresh" content="0; url=http://tiernogalvan.es/phpmyadmin">
                     </head>
                     <body>
                     </body>
                   </html>';
...
// CARGA DE PAGINAS WEB INTERNAS
	...
	include 'Comun/Cabecera_en.inc';

	echo "<body onload=\"changedate('return')\">
	<div id='centro'>";

	include_once ('Comun/Seccion1_en.inc');
	include_once ('Comun/Seccion2_en.inc');

// CONTROL DEL ROL
    if (isset($_SESSION['prueba']))
    {
    $roles=mysql_query("select us_codrol from usuarios where us_cuenta='".$_SESSION['prueba']."'");
...
else
{
 ...
 /* Opción INICIO - CONTACTAR */ 
    ...
    elseif ($_SERVER['QUERY_STRING'] == 'inicon') 
	{
		if ($rolusuario >= 0)
		{
			include 'Inicio/Contactar/Seccion3_en.inc'; 
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Inicio/Contactar/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
		...
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			echo '<div id="cuerpo-centro"> You are not allowed to enter here</div>';
 ...
 /* Opción INICIO - ENSEÑANZAS */   
	...
	elseif ($_SERVER['QUERY_STRING'] == 'iniens') 
	{
		if ($rolusuario >= 0)
		{
			include 'Inicio/Ensenanzas/Seccion3_en.inc';
			
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Inicio/Ensenanzas/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
 ...
 /* Opción INICIO - SECRETARIA */   
	...
	elseif ($_SERVER['QUERY_STRING'] == 'inisec') 
	{
		if ($rolusuario >= 0)
		{
			include 'Inicio/Secretaria/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Inicio/Secretaria/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
...
/* Opción DIRECCION - Inicio */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'dirini' || (isset($_GET['dirini'])))
	{
		if ($rolusuario >= 70)
		{
			include 'Direccion/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Direccion/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Direccion/Inicio/Seccion6_sinedit_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
	}
  ...
  /* Opción DIRECCIÓN - EQUIPO DIRECTIVO */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'direqu') 
	{
		if ($rolusuario >= 0)
		{
			include 'Direccion/EquipoDirectivo/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Direccion/EquipoDirectivo/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
  ...
  /* Opción DIRECCIÓN - CONSEJO ESCOLAR */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'dircon') 
	{
		if ($rolusuario >= 0)
		{
			include 'Direccion/Consejo/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Direccion/Consejo/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
...
/* Opción JEFATURA - Inicio */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'jefini' || (isset($_GET['jefini'])))
	{
		if ($rolusuario >= 70)
		{
			include 'Jefatura/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Jefatura/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Jefatura/Inicio/Seccion6_sinedit_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
	}
...
/* Opción JEFATURA - Documentos */  
	elseif ($_SERVER['QUERY_STRING'] == 'jefdoc' || (isset($_GET['jefdoc']))) 
	{
		...
		if (isset($_SESSION['login']) && ($_SESSION['login']=='ok'))
		{
			...
			include 'Jefatura/Documentos/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5.inc';
			include 'Jefatura/Documentos/Seccion6_en.inc';
	...
	/* Opción JEFATURA - Programaciones */  
		...
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Jefatura/Seccion5.inc';
			echo '<div id="cuerpo-centro"> You are not allowed to enter here</div>';
			echo '<meta http-equiv="refresh" content="3;url=index.php"> ';
			include 'Jefatura/Seccion7.inc';
			echo '</div>';				
		}
	}
		...
		elseif ($_SERVER['QUERY_STRING'] == 'jefpar') 
	{
		...
		{
		echo "<div id='cuerpo'>";
		include 'Jefatura/Partes/Seccion6_en.inc';
		echo "</div>";
		}
		else
		{
			include 'Jefatura/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Jefatura/Seccion5_en.inc';
			echo '<div id="cuerpo-centro"> You are not allowed to enter here</div>';
			echo '<meta http-equiv="refresh" content="3;url=index_en.php"> ';
			include 'Jefatura/Seccion7_en.inc';
			echo '</div>';				
		}
	}
...
/* Opción ADMINISTRACION - Inicio */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'admini' || (isset($_GET['admini'])))
	{
		if ($rolusuario >= 68)
		{
			include 'Administracion/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Administracion/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Administracion/Inicio/Seccion6_sinedit_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
	}
  ...
  /* Opción ADMINISTRACIÓN - SALDOS */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'admsal') 
	{
		if ($rolusuario >= 30)
		{
			include 'Administracion/Saldos/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Administracion/Saldos/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
  ...
  /* Opción ADMINISTRACIÓN - MOVIMIENTOS */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'admmov') 
	{
		if ($rolusuario >= 68)
		{
			include 'Administracion/Movimientos/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Administracion/Movimientos/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
  ...
  /* Opción ADMINISTRACIÓN - DIETAS */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'admdie') 
	{
		if ($rolusuario >= 0)
		{
			include 'Administracion/Dietas/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Administracion/Dietas/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
...
/* Opción DEPARTAMENTOS - INICIO */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'dep' || (isset($_GET['dep']))) 
	{
		if ($rolusuario >= 60)
		{
			include 'Departamentos/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Departamentos/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		elseif ($rolusuario >= 0)
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Departamentos/Inicio/Seccion6_en_sinedit.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
                }
                else
...
/* Opción ALUMNOS - Inicio */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'alu' || (isset($_GET['alu'])))
	{
		if ($rolusuario == 28)
		{
			include 'Alumnos/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Alumnos/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Alumnos/Inicio/Seccion6_sinedit_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
	}
...
/* Opción ALUMNOS - Diseños web */
	...
	elseif ($_SERVER['QUERY_STRING'] == 'aludis' || (isset($_GET['aludis']))) 
	{
		if ($rolusuario >= 0)
		{
			include 'Alumnos/Disenos/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Alumnos/Disenos/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';  
			echo "</div>";
		...
		{
			include 'Alumnos/Documentos/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			echo '<div id="cuerpo-centro"> You are not allowed to enter here</div>';
			echo '<meta http-equiv="refresh" content="3;url=index.php"> ';
...
/* Opción AMPA - Inicio */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ampini' || (isset($_GET['ampini'])))
	{
		if ($rolusuario == 14)
		{
			include 'Ampa/Inicio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Ampa/Inicio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
		{
			...
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Ampa/Inicio/Seccion6_sinedit_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
	}

/* Opción AMPA - Gestionar socios */  
	
	elseif ($_SERVER['QUERY_STRING'] == 'ampsocges' || (isset($_GET['ampsocges'])))
	{
		if ($rolusuario == 14)
		{
			include 'Ampa/GestionarSocios/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Ampa/GestionarSocios/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
...
/* Opción AMPA - Gestionar socios - Alta socios*/  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ampsocgesalta' || (isset($_GET['ampsocgesalta'])))
	{
		if ($rolusuario == 14)
		{
			include 'Ampa/GestionarSocios/AltaSocio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
...
/* Opción AMPA - Gestionar socios - Buscar socios*/  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ampsocgesbusqueda' || (isset($_GET['ampsocgesbusqueda'])))
	{
		if ($rolusuario == 14)
		{
			include 'Ampa/GestionarSocios/BuscarSocio/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Ampa/GestionarSocios/BuscarSocio/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
...
/* Opción AMPA - Gestionar socios - Pagar cuota */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ampsocgespagar' || (isset($_GET['ampsocgespagar'])))
	{
		if ($rolusuario == 14)
		{
			include 'Ampa/GestionarSocios/PagarCuota/Seccion3_en.inc';
			echo "<div id='cuerpo'>";
			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Ampa/GestionarSocios/PagarCuota/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ticini' || (isset($_GET['ticini']))) 
	{
		if ($rolusuario >= 0)
		{
			if (isset($_SESSION['login']) && ($_SESSION['login']=='ok'))
			{
					...
					include 'Tic/Inicio/Seccion3_en.inc';
					echo "<div id='cuerpo'>";
					include 'Comun/Seccion_5/Seccion5_en.inc';
					include 'Tic/Inicio/Seccion6_en.inc';
					include 'Comun/Seccion_7/Seccion7_en.inc';
...
/* Opción TIC - Recursos y condiciones de uso */  
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ticrec') 
	{
		if ($rolusuario >= 0)
		{
			include 'Tic/Condiciones/Seccion3_en.inc';
			echo "<div id='cuerpo'>";

			include 'Comun/Seccion_5/Seccion5_en.inc';
			include 'Tic/Condiciones/Seccion6_en.inc';
			include 'Comun/Seccion_7/Seccion7_en.inc';
			echo "</div>";
		}
		else
...
// Opción bolsa - trabajo 
	...
	elseif ($_SERVER['QUERY_STRING'] == 'bolsa') 
	{
		...
		include 'Comun/Seccion_5/Seccion5_en.inc';
		include 'BolsaTrabajo/Index_en.inc';
		include 'Inicio/Seccion7.inc';
	...
	elseif ($_SERVER['QUERY_STRING'] == 'boferta') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Empresa/borrarOferta/boroferta_en.inc';
		include 'Inicio/Seccion7.inc';
	...
	elseif ($_SERVER['QUERY_STRING'] == 'ofertas') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Empresa/guardarOferta/opcofertas_en.php';
		include 'Inicio/Seccion7.inc';
		...
		elseif ($_SERVER['QUERY_STRING'] == 'inscribirse') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/Inscribirse/inscribirse_en.inc';
		include 'Inicio/Seccion7.inc';
		...
		elseif ($_SERVER['QUERY_STRING'] == 'vofertas') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/listarOfertas/verofertas_en.inc';
		include 'Inicio/Seccion7.inc';
			...
			elseif ($_SERVER['QUERY_STRING'] == 'borCurriculum') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/borrarCurriculum/borCurriculum_en.inc';
		include 'Inicio/Seccion7.inc';
	...
	elseif ($_SERVER['QUERY_STRING'] == 'listarcurriculum') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Empresa/verCurriculum/listarcurriculum_en.inc';
		include 'Inicio/Seccion7.inc';
	...
	elseif ($_SERVER['QUERY_STRING'] == 'opccurriculum') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/guardarCurriculum/opccurriculum_en.php';
		include 'Inicio/Seccion7.inc';
		...
		elseif ($_SERVER['QUERY_STRING'] == 'opccurriculumbd') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/guardarCurriculum/opccurriculumbd_en.inc';
		include 'Inicio/Seccion7.inc';
		...
		elseif ($_SERVER['QUERY_STRING'] == 'opccurriculumdoc') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Alumno/guardarCurriculum/opccurriculumdoc_en.inc';
		include 'Inicio/Seccion7.inc';
			...
			elseif ($_SERVER['QUERY_STRING'] == 'opcofertabd') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Empresa/guardarOferta/opcofertabd_en.inc';
		include 'Inicio/Seccion7.inc';
		...
		elseif ($_SERVER['QUERY_STRING'] == 'opcofertadoc') 
	{
		...
		include 'Inicio/Seccion5.inc';
		include 'BolsaTrabajo/Empresa/guardarOferta/opcofertadoc_en.inc';
		include 'Inicio/Seccion7.inc';
...
/* FIN OPCIONES */     
    ...
    include_once ('Comun/Seccion8_en.inc');
