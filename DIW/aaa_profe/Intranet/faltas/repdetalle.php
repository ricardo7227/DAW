...
$query="select a.idparte,
        a.asociado_a_grave,
        concat(e.idcurso, ' - ',e.tutor) as grupo,
        concat(b.apellido1,' ',b.apellido2,',  ',b.nombre ) as nombre,
        b.tel1,
        concat(a.fecha,' - ',a.hora) as fecha,
        case when a.considerada_como='L' then 'Leve' else 'Grave' end as considerada_como,
        c.descripcion as incidencia, 
        d.descripcion as sancion,
        a.observaciones as observaciones,
        a.profesor as profesor,
        a.incitodas
        from partes a, alumnos b, incidencias c, sanciones d,cursos e 
        where       a.idalumno=b.idalumno 
                and a.idincidencia=c.idincidencia 
                and a.idsancion=d.idsancion 
                and b.idcurso=e.idcurso 
                and a.idparte=?";
