  ...
  <tr>
    ...
    <td valign="top"><div class="container_contenid_div">
        ...
        <?php } 
		 ...
		 case 1:{
          ...
          <ul class="menu_cat">
            <li><a href="filebrowser.php?seccion=1&amp;<?php if(isset($busq_act) && $busq_act) echo "busqueda=$busqueda"; else echo "id=$id" ?>&amp;set_c=1" class="thumbnail_a<?php if($cookie_vbrw == 1) echo '_activo' ?>">Thumbnals</a></li>
            <li><a href="filebrowser.php?seccion=1&amp;<?php if(isset($busq_act) && $busq_act) echo "busqueda=$busqueda"; else echo "id=$id" ?>&amp;set_c=2" class="lista_a<?php if($cookie_vbrw == 2) echo '_activo' ?>">Lista</a></li>
             <?php if(!(isset($busq_act) && !($busq_act))){ ?>
          ...
          <a href="filebrowser.php?seccion=4&amp;id=<?php echo $result_categorias_img['id_archivos'] ?>" title="<?php echo $result_categorias_img['nombre_archivos'] ?>"><img src="<?php echo isset($ruta) ?>archivos/<?php echo $result_categorias_img['archivo_archivos'] ?>" width="75" height="75" alt="" /></a>
          <?php } else {?>
	...
	$totalRows_rs_producto2 = mysql_num_rows($rs_producto2);
	  ...
	  <table border="0" cellspacing="0" cellpadding="0" class="princip">
            <tr>
              <td valign="top" class="log_in_label">Nota:</td>
              <td class="log_in_field">
			  
                Por favor, <a href="filebrowser.php?seccion=3">crea un directorio</a> antes de subir un archivo
                <?php } else { ?><table border="0" cellspacing="0" cellpadding="0" class="princip">
            <tr>
        ...
        <form action="" method="post" enctype="multipart/form-data" name="form12">
          <table border="0" cellspacing="0" cellpadding="0" class="princip">
            <tr>
              <td valign="top" class="log_in_label">Directorio</td>
              <td class="log_in_field"><input name="nombre" type="text" id="nombre" value="<?php echo((isset($_POST["nombre"]))?stripslashes($_POST["nombre"]):isset($row_rs_categoria2['name_cat'])) ?>" size="35" />              </td>
            </tr>
            <tr>
		...
		?>
		  ...
		  <?php if($mime_t == 'imagen') {?>
          <img src="img.php?file=<?php echo isset($ruta) ?>archivos/<?php echo $result_categorias_img['archivo_archivos'] ?>" alt="<?php echo $result_categorias_img['nombre_archivos'] ?>" />
          <?php } else {?>
