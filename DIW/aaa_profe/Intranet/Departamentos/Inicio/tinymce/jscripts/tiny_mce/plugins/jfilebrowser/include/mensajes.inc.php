...
$mensaje_glob_v[2]="<li>Por favor, indica un directorio</li>";//
$mensaje_glob_v[3]="<li>Por favor, escoge una imagen</li>";//
...
$mensaje_glob_v[6]="<li>Este archivo es muy grande. Por favor, escoge otro</li>";//
