...
$(document).ready(function()
{
	$("#Ingresar").click(function(evento)
		{	
			...
			{
				$("#destino").load("ingresos3.php",{cajaimporte: document.getElementById('cajaimporte').value, cajadesc: document.getElementById('cajadesc').value, cajanumcu:document.getElementById('cajanumcu').value});
			}
			else
		...
		else
		{
			...
			<form class="w3-container">
				<div class="w3-half">
					...
					<button id="Ingresar" name="Ingresar" class="w3-btn w3-teal">Ingresar</button>
				</div>
