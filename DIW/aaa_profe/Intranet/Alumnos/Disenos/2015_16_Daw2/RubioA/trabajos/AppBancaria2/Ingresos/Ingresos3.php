...
if ($comprobacionnumcu==1)
{
	...
	if ($existecuenta==1)
	{
		...
		else
		{
			...
			else
			{
				...
				$sentencia2="UPDATE cuentas SET cu_sal='" . $cu_sal ."' WHERE cu_ncu='". $cajanumcu ."';";
				$sentencia3="UPDATE clientes SET cl_sal='". $cl_sal ."' WHERE cl_dni='". $cl_dni1 ."';";
				$sentencia4="INSERT INTO movimientos (mo_ncu, mo_fec, mo_hor, mo_des, mo_imp) VALUES ('".$cajanumcu."','".$fecha."','".$hora."','".$cajadesc."',".$cu_sal.");";
	...
	{
		echo "<div class='w3-animate-opacity w3-pale-red cabecera w3-container w3-leftbar w3-border-teal'><p> Error: La cuenta no existe.</p></div>";
	}
	
}
else
{
	echo "<div class='w3-animate-opacity w3-pale-red cabecera w3-container w3-leftbar w3-border-teal'><p> Error: Numero incorrecto.</p></div>";	
}
